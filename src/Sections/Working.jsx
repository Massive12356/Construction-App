  ...
  return (
    <div id='working' className='w-full bg-white'>
      <motion.div initial='hidden' whileInView='visible' variants={slideUpVariants} className='lg:w-[80%] w-[90%] m-auto py-[60px] flex flex-col justify-between items-center gap-[20px]'>
        ...
        <motion.h1 variants={slideUpVariants} className='text-black uppercase text-[30px] md:text-[40px] font-bold text-center'>HOW IT'S WORKING</motion.h1>
        ...
        <motion.div initial='hidden' whileInView='visible' variants={zoomInVariants} className='w-full grid lg:grid-cols-4 grid-cols-1 justify-center items-start gap-[20px] mt-[30px]'>

          {
            planning.map((item, index) =>(
              <div key={index} className='flex flex-col justify-center items-center gap-2 border-2 border-yellow-500 rounded-mg p-6'>
                <div>
